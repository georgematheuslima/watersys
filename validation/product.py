...
class ProductValidation:
    def validate_product_model(product_data):
        required_fields = ["descricao", "unidade_idunidade", "valor_compra", "valor_venda", "unidades"]
        ...
        invalid_fields = [field for field in ["valor_compra", "valor_venda"] if not is_valid_non_negative_number(product_data.get(field, 0))]
